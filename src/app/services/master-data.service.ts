...
export class MasterDataService {
  public tasks: Task[] = [
    ...
    { id: 6, title: "Task 6", description: "Add view task", completed: true, created: "1999-12-17T03:24:00" },
    { id: 7, title: "Task 7", description: "Any delete action should show a warning message before actually deleting", completed: true, created: "1999-12-17T03:24:00" },
